...
public class ManageNetworksJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageNetworksJPanel(JPanel upc, Business b, UserAccount ua) {
        initComponents();
    ...
    public void refreshEmployeeTable() {
        ...
        for (Network e : b.getNetDir().getNetworkList()) {
    ...
    private void initComponents() {
        ...
        employeeJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Administrator", "Admin Username"
            }
        ));
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        JPanel panel = new CreateNetworkAdmin(userProcessContainer, b, userAccount, this);
