...
public class ManageEmployeesJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageEmployeesJPanel(JPanel upc, Business b, UserAccount ua) {
        initComponents();
    ...
    public void refreshEmployeeTable() {
        ...
        for (Employee emp : o.getEmpd().getEmpList()) {
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        JPanel panel = new CreateEmployeeJPanel(userProcessContainer, b, userAccount,this);
