 ...
 * @author Bethi
 */
public class VaccineTestingSentRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public VaccineTestingSentRequestJPanel(JPanel upc, Business b, UserAccount ua) {
        initComponents();
    ...
    private void refreshWorkReqTable() {
        ...
        for (WorkRequest wr : o.getSentWorkQueue().getWrList()) {
            ...
            row[0] = mwr;
            row[1]=mwr.getSender();
            row[2] = mwr.getReceiver();
            row[3] = mwr.getReqDetail();
            row[4] = mwr.getStatus();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vaccine Testing Sent requests");
        ...
        workReqTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Sender", "Receiver", "Detail", "Status"
            }
        ));
