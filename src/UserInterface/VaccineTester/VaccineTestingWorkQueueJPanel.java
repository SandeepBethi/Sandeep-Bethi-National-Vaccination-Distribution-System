 ...
 * @author Bethi
 */
public class VaccineTestingWorkQueueJPanel extends javax.swing.JPanel {
     ...
     */
    public VaccineTestingWorkQueueJPanel(JPanel upc, Business b, UserAccount ua) {
        initComponents();
    ...
    public void refreshWorkReqTable() {
        ...
        for(WorkRequest wr:o.getWorkQueue().getWrList()){
            ...
            if(mwr.getRfr().getCartonList().size()>0){
            row[2] = mwr.getRfr().getCartonList().get(0).getPackageList().get(0);
            }else{
                row[2] = mwr.getRfr().getPackageList().get(0);
            }
            row[3] = mwr.getSender();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vaccine testing Work Queue");
        ...
        workReqTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Type", "Vaccine", "Sender", "Receiver", "Status"
            }
        ) {
    ...
    return;
        ...
        if(sr.getReceiver()==null&&!sr.getStatus().equals(WorkRequest.StatusType.TestResultReported.toString())){
        sr.setReceiver(userAccount);
        sr.setStatus(WorkRequest.StatusType.PendingAtLab.toString());
        refreshWorkReqTable();
        }else{
...
if(wr.getReceiver()!=null&&!wr.getStatus().equals(WorkRequest.StatusType.TestResultReported.toString())){
    if(wr.getReceiver()==userAccount){
        if(wr.getStatus().equals(WorkRequest.StatusType.PendingAtLab.toString())){
             if(wr.getClass().equals(LabTestingRequest.class)){
            
            
            LabTestingRequest mwr = (LabTestingRequest) wr;
            
             JPanel panel = new ViewRequestDetails(userProcessContainer, b, userAccount,mwr);
