...
public class VaccineManufacturingWorkQueueJPanel extends javax.swing.JPanel {
    ...
    public void refreshWorkReqTable() {
        ...
        for (WorkRequest wr : o.getWorkQueue().getWrList()) {
            VaccineDispositionRequest mwr = (VaccineDispositionRequest) wr;
            for(VaccinePackage drugpackage:mwr.getPackageList()){
            Object row[] = new Object[3];
            row[0] = mwr;
            row[1] = drugpackage.getVaccine().getName();
            row[2] = mwr.getPackageList().size();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vaccine Disposition Work Queue");
        ...
        workReqTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Vaccine Name", "Quantity"
            }
        ) {
        ...
        buttonProcess.setText("Dispose Vaccines");
    ...
    private void buttonAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAssignActionPerformed
        ...
        VaccineDispositionRequest sr = (VaccineDispositionRequest) workReqTable.getValueAt(selectetedRow, 0);
if (sr.getStatus() !=WorkRequest.StatusType.Resolved.toString()) {
    ...
    private void buttonProcessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonProcessActionPerformed
        ...
        VaccineDispositionRequest ddr=(VaccineDispositionRequest)workReqTable.getValueAt(selectetedRow, 0);
        for(VaccinePackage dp:ddr.getPackageList()){
            dp.setStatus("Illegitimate-Disposed");
        }
