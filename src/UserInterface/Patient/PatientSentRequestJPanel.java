 ...
 * @author Bethi
 */
public class PatientSentRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public PatientSentRequestJPanel(JPanel upc, Business b, UserAccount ua) {
        initComponents();
    ...
    private void refreshWorkReqTable() {
        ...
        for (WorkRequest wr : p.getSentRequests().getWrList()) {
            ...
            row[2] = mwr.getPackageList().get(0);
            row[3] = mwr.getSender();
            row[4] = mwr.getReceiver();
            row[5] = mwr.getStatus();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inventory Sent Work Queue");
